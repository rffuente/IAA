    ...
    double alfa, double beta, vector<vector<int> > D)
{
    ...
    int max_backjumping = 80*n;
    if(n > 10)
    {
        max_backjumping = 150*n;
    }
    if(n > 12)
    {
        max_backjumping = 180*n;
    }
    int reset = 0;
                    ...
                    else
                    {
                        ...
                        */
                        if(multiple_plus_assign == 3)
                        {
                            //list_vetoed.push_back(oponent_team);
                            bool flag = false;
                            list_vetoed[team][round].push_back(oponent_team%n);
                            backjumping = backjumping + 1;
                            for(int j = 0; j < 2*n-2+k; j++)
                            {
                                for(int i = 0; i < n; i++)
    ...
    //cout << "C1: " << verifyC1(S_tr[0], n, k) << "\n";
    cout << "C2: " << verifyC2(S_tr[0], n, k) << "\n";
    cout << "C3: " << verifyC3(S_tr[0], n, k) << "\n";
    cout << "C4: " << verifyC4(S_tr[0], n, 3, k) << "\n";
    cout << "C5: " << verifyC5(S_tr[0], n, 1, k) << "\n";
    cout << "C6: " << verifyC6(S_tr[0], n, k) << "\n";
